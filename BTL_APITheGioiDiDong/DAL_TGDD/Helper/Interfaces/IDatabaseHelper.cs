...
namespace DataAccessLayer
{
    ...
    public interface IDatabaseHelper
    {
        ...
        //bool ExecuteScalarSProcedureWithTransaction(out string msgError, string v1, string v2, object maSP, string v3, object tenSP, string v4, object maDM, string v5, object soLuong, string v6, object ghiChu);
        #endregion
    }
